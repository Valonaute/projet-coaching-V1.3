...
{% block content %}
    {{ form(form)}}
{% endblock %}", "article/create.html.twig", "C:\\wamp\\www\\symfony\\projet-Coaching-symfony-v1.2-main\\projet-Coaching-symfony-v1.2-main\\templates\\article\\create.html.twig");
    }
}
