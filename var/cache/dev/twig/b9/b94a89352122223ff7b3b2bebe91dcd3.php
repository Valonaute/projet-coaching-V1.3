...
{% block content %}
    {{ form(form)}}
{% endblock %}", "product/create.html.twig", "C:\\wamp\\www\\symfony\\projet-Coaching-symfony-v1.2-main\\projet-Coaching-symfony-v1.2-main\\templates\\product\\create.html.twig");
    }
}
